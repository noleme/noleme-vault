...
public class FactoryTest
{
    ...
    {
        var container = new VaultFactory().populate(new Cellar(), "com/noleme/vault/parser/simple.json");
    ...
    {
        var container = new VaultFactory().populate(new Cellar(), "com/noleme/vault/parser/simple.yml");
